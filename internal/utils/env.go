...
func GoList(args ...string) *exec.Cmd {
	...
	if UseGOMOD("") {
		if !(strings.Contains(strings.Join(args, "|"), "github.com/0xDezzy/cutego/internal") && !strings.Contains(strings.Join(args, "|"), "github.com/0xDezzy/cutego/internal/binding/runtime")) {
